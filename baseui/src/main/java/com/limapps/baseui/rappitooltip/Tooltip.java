...
import static com.limapps.baseui.rappitooltip.Tooltip.Gravity.BOTTOM;
import static com.limapps.baseui.rappitooltip.Tooltip.Gravity.CENTER;
import static com.limapps.baseui.rappitooltip.Tooltip.Gravity.LEFT;
import static com.limapps.baseui.rappitooltip.Tooltip.Gravity.RIGHT;
import static com.limapps.baseui.rappitooltip.Tooltip.Gravity.TOP;
import static com.limapps.baseui.rappitooltip.Utils.log;
...
public final class Tooltip {
    ...
    public interface TooltipView {
        ...
        void showOnlyForSeconds(int seconds);
        ...
        void setText(final SpannableString spannable);
    ...
    static class TooltipViewImpl extends ViewGroup implements TooltipView {
        ...
        private final View mCustomMainView;
        ...
        private final Handler mHandlerShow = new Handler();
        ...
        public TooltipViewImpl(Context context, final Builder builder) {
            ...
            this.mPadding = theme.getDimensionPixelSize(R.styleable.TooltipLayout_tooltip_padding, 30);
            ...
            this.mTextViewElevation = theme.getDimension(R.styleable.TooltipLayout_tooltip_elevation, 0);
            int overlayStyle = theme.getResourceId(R.styleable.TooltipLayout_tooltip_overlayStyle, R.style.ToolTipOverlayDefaultStyle);

            String font = theme.getString(R.styleable.TooltipLayout_tooltip_font);

            theme.recycle();

            this.mToolTipId = builder.id;
            this.mText = builder.text;
            this.mSpannable = builder.spannable;
            this.mGravity = builder.gravity;
            this.mTextResId = builder.textResId;
            this.mCustomMainView = builder.customMainView;
        ...
        @Override
        public void showOnlyForSeconds(int seconds) {
            show();
            mHandlerShow.postDelayed(new Runnable() {
                @Override
                public void run() {
                    try {
                        hide();
        ...
        private void initializeView() {
            ...
            if (mCustomMainView != null) {
                mView = mCustomMainView;
            } else {
    ...
    public static final class Builder {
        ...
        int defStyleAttr = R.attr.tooltip_defaultStyle;
        ...
        public Builder withCustomView(View view, boolean replaceBackground) {
        ...
        public Builder spannable(SpannableString spannable) {
            throwIfCompleted();
