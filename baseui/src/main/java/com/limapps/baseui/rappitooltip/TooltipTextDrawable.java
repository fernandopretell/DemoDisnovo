...
class TooltipTextDrawable extends Drawable {
    ...
    public TooltipTextDrawable(final Context context, final Tooltip.Builder builder) {
        ...
        this.ellipseSize = theme.getDimensionPixelSize(R.styleable.TooltipLayout_tooltip_cornerRadius, 4);
        final int strokeWidth = theme.getDimensionPixelSize(R.styleable.TooltipLayout_tooltip_strokeWeight, 2);
        final int backgroundColor = theme.getColor(R.styleable.TooltipLayout_tooltip_backgroundColor, 0);
        final int strokeColor = theme.getColor(R.styleable.TooltipLayout_tooltip_strokeColor, 0);
        this.arrowRatio = theme.getFloat(R.styleable.TooltipLayout_tooltip_arrowRatio, ARROW_RATIO_DEFAULT);
        theme.recycle();
